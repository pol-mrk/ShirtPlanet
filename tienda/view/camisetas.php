...
&nbsp;&nbsp;
            ...
            <form class="d-flex">
                <a class="navbar-brand" href="carrito.php"><img src="../../img/carrito.png" alt="" class="img2"></a>
...
&nbsp;&nbsp;
    ...
    <form method="post" action="../process/update_carrito.php">   
...
<input type="text" name="id_camiseta" value="<?php echo "{$camiseta['id']}";?>" hidden>
     ...
     <button type="submit" name="submit">COMPRAR CAMISETA</button>     
    </form>
